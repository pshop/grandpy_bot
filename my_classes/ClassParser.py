...
class Parser:
    ...
    def __string_to_list(self, my_string):
        ...
        for word in my_list:
            if word == 'la':
                print("{} = la".format(word))
        return my_list
    
    def __delete_irrelevant_words(self, my_list):
        my_list = [word for word in my_list if word not in self.stop_words]
        return my_list
